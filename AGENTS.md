...
- Added per-package `example/` files for all 4 library packages demonstrating real CRUD usage.
- Published all 5 packages to pub.dev: `keyring_core`, `keyring_web`, `keyring_native`, `keyring`, `keyring_cli`.
- Pushed repo to GitHub at https://github.com/kingwill101/keyring.
